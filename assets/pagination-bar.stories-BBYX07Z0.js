import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as Q}from"./index-OJ7QbjDu.js";import{P as U,a as W,b as X,c as Y}from"./pagination-nav-T3e5qI6Z.js";import"./select-fallback-item-CAlcqP-v.js";import"./utils-CDN07tui.js";import"./index-C2vczdB5.js";import"./chevron-left-CzHBIiOm.js";import"./createLucideIcon-BRUIOxYu.js";import"./chevron-right-Cs4mL8WS.js";import"./chevron-down-vsUXeLsc.js";import"./scroll-area-auto-size-DIMzJfAQ.js";import"./index-BLnlIFXI.js";import"./index-DwwQKGe_.js";import"./index-dMEG8esF.js";import"./index-vJq8CsoX.js";import"./index-jm-SPu3n.js";import"./index-Dc1_MvIw.js";import"./index-ehd_yKDV.js";import"./index-R2u7xokr.js";import"./index-ikjn6k1p.js";import"./index-J9NOjVw1.js";import"./index-BkBxvK4w.js";import"./index-aeuf1bbk.js";import"./index-CxFCylgP.js";import"./index-nJQzngU_.js";import"./index-9WfwfrTN.js";function b({pageNo:a,pageSize:n,onPageChange:s,...x}){const i=Math.max(n,1),z=Math.min(Math.max(a,1),i),g=Math.floor((z-1)/10)*10+1,P=Math.min(g+9,i),J=Array.from({length:Math.max(0,P-g+1)},(p,K)=>g+K),f=p=>{p!==z&&(s==null||s(p))};return e.jsxs(U,{...x,children:[e.jsx(W,{disabled:g===1,onClick:()=>f(Math.max(g-1,1))}),J.map(p=>e.jsx(X,{isCurrent:z===p,onClick:()=>f(p),children:p},p)),e.jsx(Y,{disabled:P===i,onClick:()=>f(Math.min(P+1,i))})]})}b.__docgenInfo={description:"",methods:[],displayName:"PaginationBar",props:{pageNo:{required:!0,tsType:{name:"number"},description:""},pageSize:{required:!0,tsType:{name:"number"},description:""},onPageChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(page: number) => void",signature:{arguments:[{type:{name:"number"},name:"page"}],return:{name:"void"}}},description:""}}};const he={title:"M2/PaginationBar",component:b,parameters:{layout:"centered",controls:{include:["pageNo","pageSize"]},docs:{description:{component:`
### 페이지네이션 바 컴포넌트
...
}`,...(H=(V=S.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};const Ce=["Playground","Examples","FewPages","TenPages","MultipleGroups","LargeDataset","StartingAtDifferentPages","EdgeCases"];export{S as EdgeCases,m as Examples,l as FewPages,N as LargeDataset,d as MultipleGroups,t as Playground,u as StartingAtDifferentPages,c as TenPages,Ce as __namedExportsOrder,he as default};
