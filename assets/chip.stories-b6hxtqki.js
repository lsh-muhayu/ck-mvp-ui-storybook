import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./index-OJ7QbjDu.js";import{c as F}from"./index-C2vczdB5.js";import{c as K}from"./utils-CDN07tui.js";import{R as Q}from"./index-iTePWsE_.js";import{C as Y}from"./check-XAxGDgGN.js";import{S as v}from"./star-CVmaTZu_.js";import{H as j}from"./heart-CZOb14Z3.js";import{U as Z}from"./user-DKwQRr9F.js";import{S as $}from"./settings-BWfxB16v.js";import{c as ee}from"./createLucideIcon-BRUIOxYu.js";import{X as i}from"./x-rbQ9-OCx.js";import"./index-BLnlIFXI.js";import"./index-DwwQKGe_.js";import"./index-dMEG8esF.js";import"./index-CxFCylgP.js";/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const se=[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]],l=ee("tag",se),ae=F(["inline-flex cursor-pointer items-center justify-center gap-1.5 rounded-full","border-m2-gray-3 text-m2-secondary border font-medium transition-all","disabled:hover:text-m2-secondary disabled:cursor-not-allowed disabled:opacity-50"],{variants:{size:{xs:"px-2 py-0.5 text-xs",sm:"px-2.5 py-1 text-sm",md:"px-3 py-1.5 text-base",lg:"px-4 py-2 text-lg"},color:{primary:"hover:text-m2-primary not-disabled:hover:border-m2-primary focus-visible:text-m2-primary focus-visible:outline-m2-primary data-[state=on]:border-m2-primary data-[state=on]:bg-m2-primary data-[state=on]:text-white",secondary:"hover:text-m2-secondary not-disabled:hover:border-m2-secondary focus-visible:text-m2-secondary focus-visible:outline-m2-secondary data-[state=on]:border-m2-secondary data-[state=on]:bg-m2-secondary data-[state=on]:text-white",success:"hover:text-m2-success not-disabled:hover:border-m2-success focus-visible:text-m2-success focus-visible:outline-m2-success data-[state=on]:border-m2-success data-[state=on]:bg-m2-success data-[state=on]:text-white",warning:"hover:text-m2-warning not-disabled:hover:border-m2-warning focus-visible:text-m2-warning focus-visible:outline-m2-warning data-[state=on]:border-m2-warning data-[state=on]:bg-m2-warning data-[state=on]:text-white",danger:"hover:text-m2-danger not-disabled:hover:border-m2-danger focus-visible:text-m2-danger focus-visible:outline-m2-danger data-[state=on]:border-m2-danger data-[state=on]:bg-m2-danger data-[state=on]:text-white",info:"hover:text-m2-info not-disabled:hover:border-m2-info focus-visible:text-m2-info focus-visible:outline-m2-info data-[state=on]:border-m2-info data-[state=on]:bg-m2-info data-[state=on]:text-white",urgent:"hover:text-m2-urgent not-disabled:hover:border-m2-urgent focus-visible:text-m2-urgent focus-visible:outline-m2-urgent data-[state=on]:border-m2-urgent data-[state=on]:bg-m2-urgent data-[state=on]:text-white"}},defaultVariants:{size:"xs",color:"primary"}});function s({className:a,size:f,color:n,...g}){return e.jsx(Q,{className:K(ae({size:f,color:n}),a),...g})}s.__docgenInfo={description:"",methods:[],displayName:"Chip"};const je={title:"M2/Chip",component:s,parameters:{layout:"centered",docs:{description:{component:`
### 선택 가능한 칩 컴포넌트
...
- **선택(pressed) 상태**: 해당 색상으로 채워집니다.
        `}}},render:()=>e.jsxs("div",{className:"flex flex-col gap-6",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h3",{className:"text-m2-gray-1 text-sm font-semibold",children:"기본 (비선택)"}),e.jsx("div",{className:"flex flex-wrap gap-3",children:C.map(a=>e.jsx(s,{color:a,children:a},a))})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h3",{className:"text-m2-gray-1 text-sm font-semibold",children:"선택 (pressed)"}),e.jsx("div",{className:"flex flex-wrap gap-3",children:C.map(a=>e.jsx(s,{color:a,defaultPressed:!0,children:a},a))})]})]})},o={render:()=>e.jsxs("div",{className:"flex flex-col gap-6",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h3",{className:"text-m2-gray-1 text-sm font-semibold",children:"아이콘과 함께"}),e.jsxs("div",{className:"flex flex-wrap gap-3",children:[e.jsxs(s,{size:"md",children:[e.jsx(Y,{className:"size-4"}),"완료"]}),e.jsxs(s,{size:"md",children:[e.jsx(v,{className:"size-4"}),"즐겨찾기"]}),e.jsxs(s,{size:"md",children:[e.jsx(j,{className:"size-4"}),"좋아요"]}),e.jsxs(s,{size:"md",children:[e.jsx(Z,{className:"size-4"}),"프로필"]}),e.jsxs(s,{size:"md",children:[e.jsx($,{className:"size-4"}),"설정"]})]})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h3",{className:"text-m2-gray-1 text-sm font-semibold",children:"아이콘만"}),e.jsxs("div",{className:"flex flex-wrap gap-3",children:[e.jsxs(s,{size:"md",children:[e.jsx(l,{className:"size-4"}),"태그"]}),e.jsxs(s,{size:"md",children:[e.jsx(v,{className:"size-4"}),"중요"]}),e.jsxs(s,{size:"md",children:[e.jsx(j,{className:"size-4"}),"관심"]})]})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h3",{className:"text-m2-gray-1 text-sm font-semibold",children:"삭제 버튼 포함"}),e.jsxs("div",{className:"flex flex-wrap gap-3",children:[e.jsxs(s,{size:"md",children:[e.jsx(l,{className:"size-3.5"}),"React",e.jsx(i,{className:"size-3.5"})]}),e.jsxs(s,{size:"md",children:[e.jsx(l,{className:"size-3.5"}),"Vue",e.jsx(i,{className:"size-3.5"})]}),e.jsxs(s,{size:"md",children:[e.jsx(l,{className:"size-3.5"}),"TypeScript",e.jsx(i,{className:"size-3.5"})]})]})]})]})};function le(){const[a,f]=r.useState(!1),[n,g]=r.useState(!0),[N,W]=r.useState(!1),[u,q]=r.useState(!1);return e.jsxs("div",{className:"flex w-[500px] flex-col gap-6",children:[e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h3",{className:"text-m2-gray-1 text-sm font-semibold",children:"Interactive Chips"}),e.jsxs("div",{className:"flex flex-wrap gap-3",children:[e.jsx(s,{pressed:a,onPressedChange:f,children:"React"}),e.jsx(s,{pressed:n,onPressedChange:g,children:"Vue"}),e.jsx(s,{pressed:N,onPressedChange:W,children:"Angular"}),e.jsx(s,{pressed:u,onPressedChange:q,children:"Svelte"})]})]}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("h3",{className:"text-m2-gray-1 text-sm font-semibold",children:"선택 상태"}),e.jsxs("div",{className:"text-m2-secondary text-sm",children:[e.jsxs("div",{children:["React: ",a?"선택됨":"선택 안 됨"]}),e.jsxs("div",{children:["Vue: ",n?"선택됨":"선택 안 됨"]}),e.jsxs("div",{children:["Angular: ",N?"선택됨":"선택 안 됨"]}),e.jsxs("div",{children:["Svelte: ",u?"선택됨":"선택 안 됨"]})]})]})]})}const x={parameters:{docs:{description:{story:`
...
}`,...(b=(y=t.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};var S,w,P;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...(P=(w=d.parameters)==null?void 0:w.docs)==null?void 0:P.source}}};var R,T,V;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
...
}`,...(V=(T=c.parameters)==null?void 0:T.docs)==null?void 0:V.source}}};var E,k,I;m.parameters={...m.parameters,docs:{...(E=m.parameters)==null?void 0:E.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
}`,...(I=(k=m.parameters)==null?void 0:k.docs)==null?void 0:I.source}}};var L,M,B;o.parameters={...o.parameters,docs:{...(L=o.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
...
}`,...(B=(M=o.parameters)==null?void 0:M.docs)==null?void 0:B.source}}};var O,X,A;x.parameters={...x.parameters,docs:{...(O=x.parameters)==null?void 0:O.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
}`,...(A=(X=x.parameters)==null?void 0:X.docs)==null?void 0:A.source}}};var D,_,H;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
...
}`,...(H=(_=p.parameters)==null?void 0:_.docs)==null?void 0:H.source}}};var U,G,J;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
...
}`,...(J=(G=h.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};const Ce=["Playground","Basic","Sizes","Colors","WithIcons","Interactive","States","Examples"];export{d as Basic,m as Colors,h as Examples,x as Interactive,t as Playground,c as Sizes,p as States,o as WithIcons,Ce as __namedExportsOrder,je as default};
